...
namespace Client.Misc.Printing
{
    public class PrintHandler
    {
        ...
        public PrintHandler(PrintDocument printDocument1)
        {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            try
            {
                ...
                while (iRow <= dataGridView1.Rows.Count - 1)
                {
                    ...
                    if (GridRow.Visible == false) continue;
                    //Set the cell height
                    ...
                    else
                    {
                        ...
                        {
                            //Draw Header
                            e.Graphics.DrawString(docHeader,
                                new Font(dataGridView1.Font, FontStyle.Bold),
                                Brushes.Black, e.MarginBounds.Left,
                                e.MarginBounds.Top - e.Graphics.MeasureString(docHeader,
                                new Font(dataGridView1.Font, FontStyle.Bold),
                            ...
                            foreach (DataGridViewColumn GridCol in dataGridView1.Columns)
                            {
                                if (GridCol.Visible == false) continue;
